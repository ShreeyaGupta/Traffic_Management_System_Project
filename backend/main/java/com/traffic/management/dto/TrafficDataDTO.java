...
public class TrafficDataDTO {
		...
		public TrafficDataDTO(String roadName, String detectorName, Double occupancyPercentage, Double averageSpeed,
				Integer volume, Integer classOneVolume, Integer classTwoVolume, Integer classThreeVolume,
				Integer period, Date date, int congestionLevel) {
			super();
			this.roadName = roadName;
			this.detectorName = detectorName;
			this.occupancyPercentage = occupancyPercentage;
		...
		public String toString() {
			return "TrafficDataDTO [roadName=" + roadName + ", detectorName=" + detectorName + ", occupancyPercentage="
					+ occupancyPercentage + ", averageSpeed=" + averageSpeed + ", volume=" + volume
					+ ", classOneVolume=" + classOneVolume + ", classTwoVolume=" + classTwoVolume
